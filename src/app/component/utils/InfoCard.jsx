  ...
  return (
    <>
      <div className="bg-stone-100 px-10 py-4">
        ...
        <div className="flex gap-2 items-center pt-5 px-2 font-bold">
          <button
            className="px-2 bg-stone-400 shadow-md hover:bg-stone-300"
            onClick={decrement}
          >
            -
          </button>
        ...
        <div className="flex gap-2 px-2 pt-10">
          <button className="px-10 py-2 bg-red-600 shadow-md text-white font-semibold rounded-md hover:bg-red-700">
            Pesan
          </button>
          <button className="px-10 py-2 bg-red-600 shadow-md text-white font-semibold rounded-md hover:bg-red-700">
            Keranjang
